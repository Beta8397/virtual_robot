...
public class FConstants {
    static {
        ...
        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.1,0,0.01,0); // default p=0.1, d=0.01
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(1,0,0,0.6,0);  // default p = 0.1, t = 0.6
