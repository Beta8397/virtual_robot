...
/**
 * Vision is not available due to the nature of the virtual robot and the SDK not being updated to support
 * the VisionPortal. All methods will do nothing but return proper logging.
 */
@Config
...
//            builder.addProcessor(processor);
            getOpMode().log("vision processor '%' initialised.", "dummy");
//        }
...
//            visionPortal.setProcessorEnabled(processor, true);
            getOpMode().log("vision processor '%' started.", "dummy");
//        }
    }
...
//            }
//            visionPortal.setProcessorEnabled(processor, false);
            getOpMode().log("vision processor '%' paused.", "dummy");
//        }
    }
...
//            processor.setFlipped(!processor.isFlipped());
            getOpMode().log("vision processor '%' flipped %.", "dummy", "upside-down");
//        }
    }
