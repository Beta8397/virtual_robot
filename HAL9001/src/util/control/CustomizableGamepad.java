...
import util.exceptions.NotAnAlchemistException;
...
public class CustomizableGamepad {
     ...
     * @see Button
     */
    private boolean getBooleanInput(Button<Boolean> button) {
     ...
     * @see Button
     */
    private double getDoubleInput(Button<Double> button) {
     ...
     * @see Button
     */
    private double getDoubleInput(Button<Double> button, double defaultReturn) {
        if (button.getGamepadNumber() == 1) {
     ...
     * @see Vector2D
     */
    private Vector2D getVectorInput(Button<Vector2D> button) {
     ...
     * @see Vector2D
     */
    private Vector2D getVectorInput(Button<Vector2D> button, Vector2D defaultReturn) {
        if (button.getGamepadNumber() == 1) {
    ...
    public <T> T getInput(Button<T> button) {
        if (button.isBoolean()) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T getInput(Button<T> button, T defaultReturn) {
        if (button.isBoolean()) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> Button<T> getButton(String buttonName) {
        T testVal = null;
        try {
