...
import system.gui.event.GamepadEventGenerator;
...
import util.exceptions.HALGUIException;
...
public final class HALGUI {
     ...
     * @see HALMenu
     */
    public final void addRootMenu(HALMenu menu) {
        currentMenu = menu;
     ...
     * @see Payload
     */
    public final void inflate(HALMenu menu) {
     ...
     * @see Payload
     */
    public final void inflate(Class<HALMenu> menuClass, Payload payload) {
        try {
     ...
     * @see HALMenu
     */
    public final void setCursorControls(Button<Boolean> upButton, Button<Boolean> downButton, Button<Boolean> leftButton, Button<Boolean> rightButton) {
     ...
     * @see Payload
     */
    public final void back(Payload payload) {
     ...
     * @see Payload
     */
    public final void forward(Payload payload) {
