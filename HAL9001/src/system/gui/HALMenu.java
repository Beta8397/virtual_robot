...
import system.gui.event.criteria.EventCriteria;
import system.gui.event.criteria.GamepadEventCriteria;
import system.gui.viewelement.CursorConfigurable;
import system.gui.viewelement.ViewElement;
import system.gui.viewelement.eventlistener.*;
import util.control.Button;
import util.exceptions.ExceptionChecker;
import util.exceptions.HALGUIException;
import util.math.datastructures.MinHeap;
import util.math.datastructures.MultiElementMap;
...
public abstract class HALMenu {
     ...
     * @see BlinkState
     */
    private String blinkCursor(String line) {
    ...
    private final class CursorLoc implements Comparable<CursorLoc> {
         ...
         */
        private int taxicabDistance(CursorLoc otherLocation) {
