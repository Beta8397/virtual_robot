...
public class OmniWheelDrive extends SubSystem {
    ...
    /**
     * A constructor for OmniWheelDrive that uses config and default settings.
     *
     * @param robot The robot the drive is currently being used on.
     ...
     */
    public OmniWheelDrive(Robot robot, String topLeft, String topRight, String botLeft, String botRight) {
        this(robot,new SpecificParams(topLeft,topRight,botLeft,botRight), false);
    }

    /**
     * A constructor for OmniWheelDrive that uses config and encoders per meter.
     *
     * @param robot The robot the drive is currently being used on.
     * @param topLeft The top left motor config name.
     * @param topRight The top right motor config name.
     ...
     */
    public OmniWheelDrive(Robot robot, String topLeft, String topRight, String botLeft, String botRight, double encodersPerMeter) {
