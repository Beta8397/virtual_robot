...
import util.exceptions.NotARealGamepadException;
...
public final class ConfigParam {
     ...
     */
    private ConfigParam(String name, List<String> options, List<Object> vals, String defaultOption, String currentOption, String defaultGamepadOption, String currentGamepadOption, boolean usesGamepad, boolean isBoolButton, boolean isDoubleButton) {
        this.name = name;
        this.options = options;
        this.vals = vals;
        this.defaultOption = defaultOption;
